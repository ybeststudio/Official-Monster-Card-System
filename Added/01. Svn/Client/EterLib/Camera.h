#if !defined(__INC_CAMERA_H__)
#define __INC_CAMERA_H__
...
public:
	...
	static void IncreaseCameraMaxDistance(float fMax);
...
public:
	enum ECameraNum
	{
		...
		DEFAULT_MYSHOPDECO_CAMERA,
#endif
#if defined(ENABLE_MINI_GAME_YUTNORI)
		DEFAULT_YUTNORI_CAMERA,
#endif
