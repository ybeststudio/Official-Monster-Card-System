...
class KeyChangeWindow(ui.ScriptWindow):
	...
	def __BuildKeyInfo(self, fileable):
		...
		if app.ENABLE_DSS_KEY_SELECT:
			KeyUiInfoDick[70] = app.DIK_C + app.DIK_LCONTROL + self.ADDKEYBUFFERCONTROL
			KeyUiInfoDick[71] = app.DIK_V + app.DIK_LCONTROL + self.ADDKEYBUFFERCONTROL

		if app.ENABLE_EVENT_BANNER:
			KeyUiInfoDick[72] = app.DIK_E + app.DIK_LCONTROL + self.ADDKEYBUFFERCONTROL
	...
	def __BuildKeyFunction(self):
		...
		KeyFunctionInfo[0]   = player.KEY_MOVE_UP_1#lambda Key = app.DIK_UP : self.MovePlayer(Key)
		KeyFunctionInfo[1]   = player.KEY_MOVE_DOWN_1#lambda Key = app.DIK_DOWN : self.MovePlayer(Key)
		KeyFunctionInfo[2]   = player.KEY_MOVE_LEFT_1#lambda Key = app.DIK_LEFT : self.MovePlayer(Key)
		KeyFunctionInfo[3]   = player.KEY_MOVE_RIGHT_1#lambda Key = app.DIK_RIGHT : self.MovePlayer(Key)
		KeyFunctionInfo[4]   = player.KEY_CAMERA_ROTATE_POSITIVE_1#lambda type = app.CAMERA_TO_POSITIVE : self.RotateCamera(type)
		KeyFunctionInfo[5]   = player.KEY_CAMERA_ROTATE_NEGATIVE_1#lambda type = app.CAMERA_TO_NEGATIVE : self.RotateCamera(type)
		KeyFunctionInfo[6]   = player.KEY_CAMERA_ZOOM_NEGATIVE_1#lambda type = app.CAMERA_TO_NEGATIVE : self.ZoomCamera(type)
		KeyFunctionInfo[7]   = player.KEY_CAMERA_ZOOM_POSITIVE_1#lambda type = app.CAMERA_TO_POSITIVE : self.ZoomCamera(type)
		KeyFunctionInfo[8]   = player.KEY_CAMERA_PITCH_NEGATIVE_1#lambda type = app.CAMERA_TO_NEGATIVE : self.PitchCamera(type)
		KeyFunctionInfo[9]   = player.KEY_CAMERA_PITCH_POSITIVE_1#lambda type = app.CAMERA_TO_POSITIVE : self.PitchCamera(type)
		KeyFunctionInfo[10] = player.KEY_ROOTING_1#lambda : player.PickCloseItem()
		KeyFunctionInfo[11] = player.KEY_ATTACK#lambda : self.AttStart()
		KeyFunctionInfo[12] = player.KEY_RIDEMYHORS#lambda : self.__RideMyHors()
		KeyFunctionInfo[13] = player.KEY_FEEDMYHORS#lambda : self.__feedMyHors()
		KeyFunctionInfo[14] = player.KEY_EMOTION1#lambda : self.__Emotion(1)
		KeyFunctionInfo[15] = player.KEY_EMOTION2#lambda : self.__Emotion(2)
		KeyFunctionInfo[16] = player.KEY_EMOTION3#lambda : self.__Emotion(3)
		KeyFunctionInfo[17] = player.KEY_EMOTION4#lambda : self.__Emotion(4)
		KeyFunctionInfo[18] = player.KEY_AUTO_RUN
		KeyFunctionInfo[19] = player.KEY_MOVE_UP_2#lambda Key = app.DIK_UP : self.MovePlayer(Key)
		KeyFunctionInfo[20] = player.KEY_MOVE_DOWN_2#lambda Key = app.DIK_DOWN : self.MovePlayer(Key)
		KeyFunctionInfo[21] = player.KEY_MOVE_LEFT_2#lambda Key = app.DIK_LEFT : self.MovePlayer(Key)
		KeyFunctionInfo[22] = player.KEY_MOVE_RIGHT_2#lambda Key = app.DIK_RIGHT : self.MovePlayer(Key)
		KeyFunctionInfo[23] = player.KEY_CAMERA_ROTATE_POSITIVE_2#lambda type = app.CAMERA_TO_POSITIVE : self.RotateCamera(type)
		KeyFunctionInfo[24] = player.KEY_CAMERA_ROTATE_NEGATIVE_2#lambda type = app.CAMERA_TO_NEGATIVE : self.RotateCamera(type)
		KeyFunctionInfo[25] = player.KEY_CAMERA_ZOOM_NEGATIVE_2#lambda type = app.CAMERA_TO_NEGATIVE : self.ZoomCamera(type)
		KeyFunctionInfo[26] = player.KEY_CAMERA_ZOOM_POSITIVE_2#lambda type = app.CAMERA_TO_POSITIVE : self.ZoomCamera(type)
		KeyFunctionInfo[27] = player.KEY_CAMERA_PITCH_NEGATIVE_2#lambda type = app.CAMERA_TO_NEGATIVE : self.PitchCamera(type)
		KeyFunctionInfo[28] = player.KEY_CAMERA_PITCH_POSITIVE_2#lambda type = app.CAMERA_TO_POSITIVE : self.PitchCamera(type)
		KeyFunctionInfo[29] = player.KEY_ROOTING_2#lambda : player.PickCloseItem()
		KeyFunctionInfo[30] = player.KEY_RIDEHORS#lambda : self.__RideHors()
		KeyFunctionInfo[31] = player.KEY_BYEMYHORS#lambda : self.__ByeMyHors()
		KeyFunctionInfo[32] = player.KEY_EMOTION5#lambda : self.__Emotion(5)
		KeyFunctionInfo[33] = player.KEY_EMOTION6#lambda : self.__Emotion(6)
		KeyFunctionInfo[34] = player.KEY_EMOTION7#lambda : self.__Emotion(7)
		KeyFunctionInfo[35] = player.KEY_EMOTION8#lambda : self.__Emotion(8)
		KeyFunctionInfo[36] = player.KEY_EMOTION9#lambda : self.__Emotion(9)
		KeyFunctionInfo[37] = player.KEY_NEXT_TARGET

		KeyFunctionInfo[38] = player.KEY_SLOT_1#lambda : self.__PressQuickSlot(0)
		KeyFunctionInfo[39] = player.KEY_SLOT_2#lambda : self.__PressQuickSlot(1)
		KeyFunctionInfo[40] = player.KEY_SLOT_3#lambda : self.__PressQuickSlot(2)
		KeyFunctionInfo[41] = player.KEY_SLOT_4#lambda : self.__PressQuickSlot(3)
		KeyFunctionInfo[42] = player.KEY_SLOT_5#lambda : self.__PressQuickSlot(4)
		KeyFunctionInfo[43] = player.KEY_SLOT_6#lambda : self.__PressQuickSlot(5)
		KeyFunctionInfo[44] = player.KEY_SLOT_7#lambda : self.__PressQuickSlot(6)
		KeyFunctionInfo[45] = player.KEY_SLOT_8#lambda : self.__PressQuickSlot(7)
		KeyFunctionInfo[46] = player.KEY_SLOT_CHANGE_1#lambda : self.__SelectQuickSlot(0)
		KeyFunctionInfo[47] = player.KEY_SLOT_CHANGE_2#lambda : self.__SelectQuickSlot(1)
		KeyFunctionInfo[48] = player.KEY_SLOT_CHANGE_3#lambda : self.__SelectQuickSlot(2)
		KeyFunctionInfo[49] = player.KEY_SLOT_CHANGE_4#lambda : self.__SelectQuickSlot(3)

		KeyFunctionInfo[50] = player.KEY_OPEN_STATE#lambda state = "STATUS": self.interface.ToggleCharacterWindow(state)
		KeyFunctionInfo[51] = player.KEY_OPEN_SKILL#lambda state = "SKILL": self.interface.ToggleCharacterWindow(state)
		KeyFunctionInfo[52] = player.KEY_OPEN_QUEST#lambda state = "QUEST": self.interface.ToggleCharacterWindow(state)
		KeyFunctionInfo[53] = player.KEY_OPEN_INVENTORY#lambda : self.interface.ToggleInventoryWindow()
		KeyFunctionInfo[54] = player.KEY_OPEN_DDS#lambda : self.interface.ToggleDragonSoulWindowWithNoInfo()
		KeyFunctionInfo[55] = player.KEY_OPEN_MINIMAP#lambda : self.interface.ToggleMiniMap()
		KeyFunctionInfo[56] = player.KEY_OPEN_LOGCHAT#lambda : self.interface.ToggleChatLogWindow()
		KeyFunctionInfo[57] = player.KEY_SCROLL_ONOFF#lambda : self.__QuestOnOff()
		KeyFunctionInfo[58] = player.KEY_OPEN_GUILD#lambda : self.interface.ToggleGuildWindow()
		KeyFunctionInfo[59] = player.KEY_OPEN_MESSENGER#lambda : self.interface.ToggleMessenger()
		KeyFunctionInfo[60] = player.KEY_OPEN_HELP#lambda : self.interface.OpenHelpWindow()
		KeyFunctionInfo[61] = player.KEY_OPEN_ACTION#lambda state = "EMOTICON": self.interface.ToggleCharacterWindow(state)
		KeyFunctionInfo[62] = player.KEY_PLUS_MINIMAP#lambda : self.interface.MiniMapScaleUp()
		KeyFunctionInfo[63] = player.KEY_MIN_MINIMAP#lambda : self.interface.MiniMapScaleDown()
		KeyFunctionInfo[64] = player.KEY_SCREENSHOT#lambda : self.SaveScreen()
		KeyFunctionInfo[65] = player.KEY_SHOW_NAME#lambda : self.ShowName()
		...
		if app.ENABLE_DSS_KEY_SELECT:
			KeyFunctionInfo[70] = player.KEY_SELECT_DSS_1 #lambda : self.interface.DragonSoulActivate(0)
			KeyFunctionInfo[71] = player.KEY_SELECT_DSS_2 #lambda : self.interface.DragonSoulActivate(1)
		if app.ENABLE_EVENT_BANNER:
			KeyFunctionInfo[72] = player.KEY_OPEN_IN_GAME_EVENT
