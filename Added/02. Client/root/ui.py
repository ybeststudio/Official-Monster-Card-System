...
class Button(Window):
	def __init__(self, layer = "UI"):
		...
		if app.ENABLE_PARTY_MATCH or app.ENABLE_DETAILS_UI or app.ENABLE_MINI_GAME_YUTNORI:
			self.overFunc = None
			self.overArgs = None
			self.overOutFunc = None
			self.overOutArgs = None
...
class SlotWindow(Window):
	...
	if app.ENABLE_GROWTH_PET_SYSTEM or app.ENABLE_MOVE_COSTUME_ATTR or app.ENABLE_MAILBOX:
